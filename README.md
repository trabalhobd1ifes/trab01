...
Este documento contém a especificação do projeto do banco de dados “SUMEI” - Sistema Unificado para Microempreendedor Individual e motivação da escolha realizada. <br>
